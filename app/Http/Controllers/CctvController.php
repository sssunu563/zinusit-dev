...
use App\Services\CctvPrtgService;
use Carbon\Carbon;
...
{
    public function __construct(private readonly CctvPrtgService $prtg) {}

    public function index(): Response
    {
        return Inertia::render('Report/Cctv', [
            'locations' => CctvPrtgService::locations(),
        ]);
    }
    ...
    {
        $logs = CctvFetchLog::with('triggeredBy:id,name')
