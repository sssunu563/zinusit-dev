...
const props = defineProps<{
    ...
    requesterDeptHead: string;
    recipientKicker: string;
    recipientTitle: string;
    recipientCopy: string;
    requesterKicker: string;
    requesterTitle: string;
    requesterCopy: string;
...
<section class="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-400">
    <div class="space-y-10 max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        />
                        <User class="absolute left-3.5 top-1/2 -translate-y-1/2 size-3.5 text-slate-300 group-focus-within:text-[#003628] transition-colors z-10" />
                    </div>
                </div>
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <input
                            v-model="(formData as any).user_phone"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <input
                            v-model="(formData as any).user_email"
                            class="w-full h-10 px-4 pl-10 rounded-lg border border-slate-200 bg-white text-[13px] font-bold text-slate-900 focus:border-[#003628] transition-all outline-none shadow-sm"
        ...
        <div class="space-y-6">
            <div class="flex items-center gap-3 mb-2">
                <div class="h-px flex-1 bg-slate-100" />
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">IT Verification</span>
                <div class="h-px flex-1 bg-slate-100" />
            </div>
            ...
            <div class="grid grid-cols-3 gap-8">
                ...
                <div class="space-y-2">
                    <label class="text-[11px] font-black uppercase tracking-widest text-slate-400">Drafter</label>
                    <div class="relative group">
                        <div class="flex h-10 items-center rounded-lg border border-slate-200 bg-slate-50 pl-10 pr-4 text-[13px] font-black text-slate-400 shadow-inner italic">
                ...
                <!-- IT Checker -->
                <div class="space-y-2">
                    <label class="text-[11px] font-black uppercase tracking-widest text-slate-400">Checker</label>
                    <StbSearchableSelect
                        v-model="formData.itChecker_id"
                        :options="itUsers.map(u => ({ id: u.id, name: u.name }))"
                ...
                <!-- IT Approver -->
                <div class="space-y-2">
                    <label class="text-[11px] font-black uppercase tracking-widest text-slate-400">Approved</label>
                    <StbSearchableSelect
                        v-model="formData.itApproved_id"
                        :options="itUsers.map(u => ({ id: u.id, name: u.name }))"
        ...
        <div class="space-y-6">
            <div class="flex items-center gap-3 mb-2">
                <div class="h-px flex-1 bg-slate-100" />
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Profile Verification</span>
                <div class="h-px flex-1 bg-slate-100" />
            </div>
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    <label class="text-[11px] font-black uppercase tracking-widest text-slate-400">{{ requesterDeptHeadLabel }}</label>
                    <div class="relative group">
                        <div class="flex h-10 items-center rounded-lg border border-slate-200 bg-slate-50 pl-10 pr-4 text-[13px] font-black text-slate-400 shadow-inner italic">
                            {{ requesterDeptHead || 'AUTOMATIC' }}
                        </div>
                        <User class="absolute left-3.5 top-1/2 -translate-y-1/2 size-3.5 text-slate-300" />
                    </div>
                </div>
