...
const tabs = computed(() => [
    ...
    { id: 'stock', label: 'Riwayat Kursi', badge: 0 },
                ...
                <div class="p-6">
                    ...
                    <div v-if="activeTab === 'info'" class="space-y-6">
                        ...
                        >
                            ...
                            >
                                <KeyRound class="size-4 text-[#003628]" />
                            </div>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Check
                                        v-if="asset.maintained"
                                        class="size-3.5"
                                    />
                                    <Ban v-else class="size-3.5" />
                                    {{ asset.maintained ? 'Ya' : 'Tidak' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            >
                                <p
                                    class="mb-3 flex items-center gap-1.5 text-[11px] font-semibold tracking-widest text-slate-500 uppercase"
                                >
                                    <Calendar class="size-3.5" /> Masa Berlaku
                                </p>
                                <dl class="space-y-2.5">
                                    <div
                                        class="flex items-center justify-between"
                    ...
                    <div v-if="activeTab === 'stock'">
                        ...
                        >
                            ...
                            <p class="text-sm font-medium text-slate-300">
                                Belum ada riwayat penambahan kursi
                            </p>
                        </div>
                    </div>
                    ...
                    <div v-if="activeTab === 'history'">
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    class="shrink-0 text-[10px] font-medium text-slate-400 tabular-nums"
                                    >{{ log.date }}</span
                                >
                            </div>
                            <!-- History Pagination -->
